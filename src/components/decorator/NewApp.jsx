...
const CheckboxList = () => {
    ...
    const handleSingleCheck = (id) => {
        const newData = checkboxes.map((value, index) => {
            if (id === index) {
                return { id: checkboxes[id]['id'], label: checkboxes[id]['label'], checked: !checkboxes[id].checked }
            }
            return value;
        })
    ...
    return (
        <Container>
            ...
            <SelectAllButton data-testid="button"
                onClick={() => {
                    setCheckboxes(checkboxes.map((value, index) => {
